...
This folder defines all source code for the 'ingestion to bronze' pipeline:
...
* Take a look at the sample under "sample_users_ingestion_to_bronze.py" to get familiar with the syntax.
