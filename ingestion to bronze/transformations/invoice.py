...
volume_path=f'/Volumes/{catalog_name}/staging/p2p2_files/invoice'
...
@dlt.view(name="raw_invoice_binary")
def raw_invoice_binary() -> DataFrame:
    return (
        spark.readStream
            .format("cloudFiles")
